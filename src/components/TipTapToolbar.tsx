...
import { Bold, Code, CodepenIcon, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6, Italic, List, ListOrdered, Quote, Redo2, Strikethrough, Undo2 } from 'lucide-react'
...
const TipTapToolbar = ({ editor }: Props) => {
  return (
    <div className='flex flex-wrap gap-3'>
      ...
      >
        <Bold className='h-6 w-6' strokeWidth={3} />
      </button>
